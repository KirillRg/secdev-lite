...
| **Edge: Internet → API**                            | Request                             | T                    | Манипуляция входным телом/заголовками (несанкционированные поля).    | NFR-008 (#131)     | JSON schema/DTO strict, запрет extra полей, лимит размеров.                           |
